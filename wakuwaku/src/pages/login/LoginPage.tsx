...
export function LoginPage(): JSX.Element {
  ...
  >
    <SimpleCard title="WakuWaku" className="min-w-[300px] w-full max-w-[720px] box-border relative">
      {/* Top section - lead text and carousel */}
      <Row>
        {/* Lead text */}
        <Col flex="1">
          <p className="mt-0 text-justify">
            Welcome to WakuWaku, a client for <ExtLink href="https://www.wanikani.com">WaniKani</ExtLink>, an SRS
            ...
            children: (
              <>
                <p className="text-justify mb-sm">
                  Log in to your <strong>standalone</strong> WakuWaku account.
                </p>
                <Form
                  layout="vertical"
