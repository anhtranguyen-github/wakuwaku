...
function TopRow({ withThemeToggle }: Props) {
  ...
  return <div className="flex flex-wrap items-center justify-center gap-sm text-desc">
    {/* Attribution */}
    <span>
      WakuWaku is a project by <Link href="https://lemmmy.me">Lemmmy</Link>
    </span>

    <Separator />

    {/* GitHub */}
    <Link href="https://github.com/Lemmmy/WakuWaku">GitHub</Link>
...
const WaniKaniAttribution = () => <>
  ...
  &copy; <Link href="https://www.tofugu.com">Tofugu LLC</Link>, made available by your WaniKani subscription. WakuWaku
