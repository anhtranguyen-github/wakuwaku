  ...
  const menuProps: MenuProps = useMemo(() => {
    const items: MenuProps["items"] = [
      ...
      // GitHub links
      {
        key: "menu-github",
        icon: <GithubOutlined />,
        label: <ExtLink href="https://github.com/Lemmmy/WakuWaku">GitHub</ExtLink>
      },
      {
        key: "menu-github-changelog",
        icon: <UnorderedListOutlined />,
        label: <ExtLink href="https://github.com/Lemmmy/WakuWaku/releases">Changelog</ExtLink>
      },
      {
        key: "menu-github-issues",
        icon: <BugOutlined />,
        label: <ExtLink href="https://github.com/Lemmmy/WakuWaku/issues">Report issues</ExtLink>
      }
    ];
