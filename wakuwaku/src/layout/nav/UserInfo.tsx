...
export function UserInfo(): JSX.Element | null {
  ...
  return <ConditionalLink to="/profile" matchTo className="text-basec no-underline">
    <div className="flex flex-col items-end justify-center text-right px-lg leading-snug">
...
export function MenuUserInfo(): JSX.Element | null {
  ...
  return <ConditionalLink to="/profile" matchTo className="block text-basec no-underline">
    <div className="flex mt-[-4px] px-md py-xs text-base bg-black/25 light:bg-black/8 rounded">
